(function () {
            ...
            if(jQuery("#card_number").length <= 0){
              ...
              for (
                  l = [
                      ...
                      a = !1,
                      t && ("object" == typeof t ? ((n = t), (a = !1), (t = null)) : "function" == typeof t && (a = !0)),
                      null == n && (n = {}),
                      null == n.accept &&
                          (n.accept = (function () {
                              var e, t, n;
              ...
              return (
                  ...
                  (d = (function (e) {
                      return function (e) {
                          var t, n;
                          return (i = o(e)), (n = !1), (t = !1), null != i && ((n = c(e)), (t = s(e, i))), { card_type: i, valid: n && t, luhn_valid: n, length_valid: t };
                      };
                  })(this)),
                  (g = (function (e) {
                      return function () {
  ...
  "undefined" != typeof module && module.exports && (module.exports = t),
      ...
      t.languages.insertBefore("javascript", "keyword", { regex: { pattern: /(^|[^/])\/(?!\/)(\[.+?]|\\.|[^/\r\n])+\/[gim]{0,3}(?=\s*($|[\r\n,.;})]))/g, lookbehind: !0 } }),
      t.languages.markup &&
          t.languages.insertBefore("markup", "tag", {
              script: { pattern: /<script[\w\W]*?>[\w\W]*?<\/script>/gi, inside: { tag: { pattern: /<script[\w\W]*?>|<\/script>/gi, inside: t.languages.markup.tag.inside }, rest: t.languages.javascript } },
          }),
      $(function () {
          return (
              $(".demo .numbers li")
              ...
              $("#card_number").validateCreditCard(
                  function (e) {
                      return (
                          $(this).removeClass(),
                          null == e.card_type
                              ? void $(".vertical.maestro").slideUp({ duration: 200 }).animate({ opacity: 0 }, { queue: !1, duration: 200 })
                              : ($(this).addClass(e.card_type.name),
                                "maestro" === e.card_type.name
                                    ? $(".vertical.maestro").slideDown({ duration: 200 }).animate({ opacity: 1 }, { queue: !1 })
