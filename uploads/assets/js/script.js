...
$(document).ready(function () {
  ...
  function applyStatusFromURL(selectSelector, paramName = "book_status") {
    ...
    // Find select directly or inside wrapper
    ...
    $select.each(function () {
      ...
      $sel.find("option").each(function () {
        if ($(this).val().trim().toLowerCase() === status) {
  ...
  applyStatusFromURL("#book_status");
