        ...
        <div class="container-fluid bg_dark-white">
            <div class="bg_white wrap_reservation">
                ...
                <div class="addReservationForm wrap_reservation_list">
                    <form id="myForm" class="admin_restaurant_from" action="<?php echo site_url('admin/insert_restaurant');?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-9">
                                <div class="restroBookRight">
                                            ...
                                            <div class="stepItem active">
                                                <div class="stepItemInner">
                                                    <div class="stepImgbox">
                                                        <div class="stepImg">
                                                            <img src="<?php echo base_url(); ?>/uploads/assets/images/chart-icon.svg" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="stepText">
                                    ...
                                    <div class="restro_info">
                                        <div class="restro_info_row restro_info_1 active">
                                            <div class="row">
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label>Restaurant Name*</label>
                                                        <input type="text" name="restaurants_name" placeholderrr="Restaurant Name*" maxlength="30"/>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                    <label>Restaurant Website URL</label>
                                                        <input type="url" name="website_link" pattern="https://.*" placeholderrr="Restaurant Website URL">
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" name="restaurants_code" placeholderrr="Restaurant Unique ID" maxlength="30"/>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    ...
                                                    <input type="url" pattern="https://.*"
                                                            name="location_link"
                                                            placeholderrr="Restaurant Map Link"></div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                    <label>Restaurant Phone Number</label>
                                                    <input type="number" name="contact_number"
                                                            placeholderrr="Restaurant Phone Number"></div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                    <label>Restaurant Email*</label>
                                                    <input type="email" name="email"
                                                            placeholderrr="Restaurant Email*"></div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                    <label>Restaurant Description*</label>
                                                    <textarea
                                                            placeholderrr="Restaurant Description*"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <textarea
                                                            placeholderrr="Restaurant Address"
                                                            name="address" id="address"></textarea></div>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-0 ">
                                                <div class="col-5 d-flex align-items-center">
                                                    ...
                                                    <div class="radio-group d-flex deposit_radio_wrap">
                                                        <label for="deposit_yes"><input type="radio" class="radio"
                                                                name="deposit" value="yes" id="deposit_yes">yes</label>
                                                        <label for="deposit_no" class="label-selected"><input
                                                                type="radio" class="radio" name="deposit" value="no"
                                                                id="deposit_no" checked>no</label>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                <label>Late Cancel/No-Show Fee</label> 
                                                    <input type="number" name="amount"
                                                        class="amount_field" placeholderrr="Deposit Amount"> </div>
                                            </div>
                                        </div>
                                        <div class="restro_info_row restro_time_info">
                                            <div class="wrap_table  all_restaurants_table action_class">
                                                <div class="leftButtonsRow btn_wrapper" id="add_slot_lists">
                                                    <button type="button" id="delete_bulk_slots" class="delete_bulk_slots_cls btn btn_add" data-resto="add">Delete Slots</button>
                                                </div>
                                                ...
                                                <div class="slotBooking">
                                                    <div class="form-group row">
                                                        <div class="col selectInput time_select">
                                                            ...
                                                            <!-- <input type="text" name="time_select" id="time_input" placeholderrr="Enter Reservation Time" class="cmnSelect1"> -->
                                                            <input type="text" name="time_select" id="time_input" placeholderrr="" class="cmnSelect1">
                                                        </div>
                                                        <div class="col">
                                                        ...
                                                        min="1" max="20" placeholderrr="Enter Table Size"> -->
                                                            <input type="number" name="table_size"
                                                        min="1" max="20" placeholderrr="">
                                                        </div>
                                                        <div class="col">
                                                            <label>Capacity</label>
                                                            <input type="number" name="capacity"
                                                        min="1" max="20" placeholderrr="Enter Capacity"></div>
                                                        <div class="col addCol"><button type="button" class="btn"
                                        ...
                                        <div class="restro_info_row">
                                            <div class="restorContentBox">
                                                ...
                                                <textarea cols="80" id="defaultEditor" class="defaultEditor" name="editor1" rows="10"></textarea>
                                            </div>
                                                ...
                                                <div class="form-group file_upload row">
                                                    <div class="col-6">
                                                        ...
                                                        <div class="file_upload_wrapper fileinput-button">
                                                            ...
                                                            <input type="file" name="menu_images[]" data-max_length="20"
                                ...
                                <div class="filterLeft">
                                    <div class="filterBlock">
                                        ...
                                        <div class="filter-body">
                                            <p>You haven't selected any filter yet you can add filter by using below
                                                link:
                                            </p>
