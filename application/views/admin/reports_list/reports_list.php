<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <h2 class="heading_title">Reports List</h2>
            <div class="booking_list_wrapper">
                <div class="booking_list_box">
                    <span>
                        <img src="<?php echo base_url(); ?>/uploads/assets/images/b1.svg" alt="">
                    </span>
                    <h4>Restaurant Slot <br />
                        Reservation Reports </h4>
                    ...
                    <a href="<?php echo site_url('admin/restaurant_slot_report_list');?>" class="stretched-link"></a>
                </div>
                <div class="booking_list_box">
                    <span>
                        <img src="<?php echo base_url(); ?>/uploads/assets/images/b1.svg" alt="">
                    ...
                    <a href="<?php echo site_url('admin/complete_booking_report_list');?>" class="stretched-link"></a>
                </div>
                <div class="booking_list_box">
                    <span>
                        <img src="<?php echo base_url(); ?>/uploads/assets/images/b2.svg" alt="">
                    </span>
                    <h4>Pending <br />
                        Reservervation Reports</h4>
                    <div class="eye_button">
                        <svg id="Component_17_1" data-name="Component 17 – 1" xmlns="http://www.w3.org/2000/svg"
                            width="36.544" height="23.493" viewBox="0 0 36.544 23.493">
                            <g id="Group_108" data-name="Group 108">
                ...
                <div class="booking_list_box">
                    <span>
                        <img src="<?php echo base_url(); ?>/uploads/assets/images/b3.svg" alt="">
                    </span>
                    <h4>Partial <br />
                        Reservation Reports</h4>
                    <div class="eye_button">
                ...
                <div class="booking_list_box">
                    <span>
                        <img src="<?php echo base_url(); ?>/uploads/assets/images/b5.svg" alt="">
                    </span>
                    <h4>Cancel <br />
                        Reservation Reports</h4>
                    <div class="eye_button">
                ...
                <div class="booking_list_box">
                    <span>
                        <img src="<?php echo base_url(); ?>/uploads/assets/images/b6.svg" alt="">
                    </span>
                    <h4>All <br />
                        Booking Reports</h4>
                    <div class="eye_button">
                ...
                <div class="booking_list_box">
                    <span>
                        <img src="<?php echo base_url(); ?>/uploads/assets/images/b7.svg" alt="">
                    </span>
                    <h4>Unauthorize <br />
                        User Email Reports</h4>
                    <div class="eye_button">
                        <svg id="Component_17_1" data-name="Component 17 – 1" xmlns="http://www.w3.org/2000/svg"
                            width="36.544" height="23.493" viewBox="0 0 36.544 23.493">
                            <g id="Group_108" data-name="Group 108">
