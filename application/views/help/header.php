    ...
    <head>
        ...
        <script>
            jQuery(document).ready(function() {
                jQuery(document).on('click','.dropdownClick', function(e){
                    e.preventDefault();
                ...
                jQuery('#search').on('input', function() {
                    ...
                    if (query.length > 2) {
                        $.ajax({
                            url: "<?php echo site_url('admin/help/search'); ?>",
                            method: "GET",
                            data: {query: query},
                            dataType: "html",
        ...
        <div id="full_wrapper">
            <div id="layout-wrapper">
                <header class="top_bar">
                    ...
                    <!-- <form action="<?php //echo site_url('admin/help/search'); ?>" method="get">
               ...
               <!-- <div id="search-results"></div> -->
                ...
                if($is_index){
                    ?>
                        <section class="banner-section pos_rel">
                            <div class="container-default">
                                <div class="banner-main-info">
                                    <h5>Madison Guides</h5>
                                    <h1>Help Center</h1>
                                    <div class="search-input-wrapper pos_rel">
                                        <input type="search" id="search" placeholder="What can we help with?">
                    ...
                    ?>
                        <section class="banner-section inner-banner user-management pos_rel">
                            ...
                            if($help_page['image']){
                                ?>
                                <div class="user-icon">
                                    <img src="<?php echo  base_url('uploads_help_center/'.$help_page['image']); ?>" alt="user list">
                                </div>
                                <?php
                            }
                            ?>
                            <div class="container-default">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <div class="banner-main-info">
                                            <h5><a href="<?php echo  base_url('admin/help'); ?>">Help Center</a> <span>/ <?php echo $help_page['title']; ?></span></h5>
                                            <h1><?php echo $help_page['title']; ?></h1>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="banner-main-info">
