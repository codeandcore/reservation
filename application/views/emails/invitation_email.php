                                ...
                                if($restaurant_address_hide != 'yes'): ?>
                                    <tr>
                                        ...
                                        <td width="500px" valign="top" style="padding-left: 5px;">
                                            <p style="color: #70016a;font-size: 11px;line-height: 16px;font-weight: 500;margin: 0px; word-wrap: break-all;"><?php echo $hotel['address'];?></p>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                                    <tr>
                                    ...
                                    <?php 
                                        if($restaurant_location_hide != 'yes'): 
                            ...
                            <tr>
                                <td style="padding-bottom: 20px;" colspan="2">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <a href="<?php echo site_url('/?invite_cookie={{notify_id}}');?>"><img
                                                        src="<?php echo base_url(); ?>/uploads/emails/accept.png" alt=""></a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
