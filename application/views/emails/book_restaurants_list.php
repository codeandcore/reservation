                                        ...
                                        <td style="padding-bottom: 20px;">
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="300px">
                                                        <p style="color:#08312a;font-size: 14px;line-height: 16px;font-weight: 600;margin: 0px;"><?php echo date('D, M d, Y', strtotime($list['booking_date'])); ?></p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="300px">
                                                        <p style="color:#08312a;font-size: 14px;line-height: 16px;font-weight: 600;margin: 0px;">Table for <?php echo $list['booking_pax']; ?></p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="height:5px" colspan="2"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="300px">
                                                        <p style="color:#08312a;font-size: 14px;line-height: 16px;font-weight: 600;margin: 0px;"><?php echo $list['booking_time']; ?>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td style="padding-bottom: 20px;">
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tr>
                                                    <td colspan="2">
                                                        <h2 style="color: #08312a;font-size: 20px;line-height: 24px;font-weight: 600; margin: 0; text-transform: uppercase">Skipped Day</h2>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="height:10px" colspan="2"></td>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tr>
                                                    <td width="80px" style="padding: 5px 0;">
                                                        <p style="color:#08312a;font-size:13px;font-weight:900;margin: 0">Reason:</p>
                                                    </td>
                                                    <td width="300px">
                                                        <p style="color:#08312a;font-size:13px;font-weight:400;margin: 0"><?php echo $list['booking_reason']; ?></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
